...
1. Use the [New Prompt Request Form]([../../issues/new?template=new-prompt-request.md](https://github.com/alex1969/ai-prompt-governance/blob/main/.github/issue_template/new-prompt-request.md))
2. Include:
